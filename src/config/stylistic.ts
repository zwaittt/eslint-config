...
export interface StylisticOptions {
  react?: boolean;
  indent?: 2 | 4 | number | 'tab';
  quotes?: 'single' | 'double';
}

export const stylistic = function (options: StylisticOptions): EslintConfig[] {
  const {
    react,
    indent = 2,
    quotes = 'single',
  ...
  return [
    {
      ...
      /// https://github.com/antfu/eslint-config/blob/main/src/configs/stylistic.ts
      rules: {
